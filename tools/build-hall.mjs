...
try {
 ...
 const hall={id:d.id,name:d.name,prefecture:d.prefecture,city:d.city,floor:'スロット',seat_count:seats.length,updated_at:d.layout_date,layout_updated_at:d.layout_date,preserve_layout:true,source:{name:'みんレポ',url:d.minrepo_url,note:'台番号配置は提供資料から作成。機種確認中の台は収集結果との照合が必要。'},seats};
